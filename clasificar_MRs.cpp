...
int main() {
	...
	// leer la matriz 
	ifstream file_in("C:\\Users\\Sonia\\Desktop\\MT_constraints_2025\\MT_constraints_2025\\V9_mutants_killed_2025.csv");
	if (!file_in.is_open()) {
		cout << "Fichero MT_2025V9_mutants_killed_2025.csv no encontrado" << endl;
		return 1;
	}
	ofstream file_out("C:\\Users\\Sonia\\Desktop\\MT_constraints_2025\\MT_constraints_2025\\clasifiar_nuevas_reglas.csv");
