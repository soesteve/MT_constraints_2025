...
**V11_PROCESS_MRs.cpp** is the main program that processes the metamorphic relations MR1, ..., MR8 and,
generates all files with the 'V11_' prefix.
Specifically, this program generates the file **V11_mutants_killed.csv** which shows which mutants are killed.
This program also generates the log file **V11_process_MRs_log.txt**.



* Input files of **V11_PROCESS_MRs.cpp**:
...
* Output files of **V11_PROCESS_MRs.cpp**:

   * **V11_mutants_killed.csv**: Summary file of the mutants killed by two processes.
   ...
   This information is obtained from the files * **V11_killed_different_outputs.csv** and **V11_killed_MRx.csv** with 1 <= x <= 8.

   * **V11_killed_different_outputs.csv**: Detailed matrix of the process comparing the result of the original model with the mutated model.

   * **V11_killed_MRx.csv** with 1 <= x <= 8: Detailed matrices show the results of applying the different MRs.

   * **V11_process_MRs_log.txt**: Process log.
...
/*	file_names.push_back("out_1.txt");
	...
	*/
	...
	ofstream mutants_killed(path_out + "V11_mutants_killed.csv");

	mutants_killed << "Mutant;O1!=O1_mut;MR1;MR2;MR3;MR4;MR5;MR6;MR7;MR8;Killed\n";

	ofstream mutants_killed_2(path_out + "V11_killed_different_outputs.csv");  // Matriz detallada de la columna O1!=O1_mut
	ofstream mutants_killed_MR1(path_out + "V11_killed_MR1.csv");
	ofstream mutants_killed_MR2(path_out + "V11_killed_MR2.csv");
	ofstream mutants_killed_MR3(path_out + "V11_killed_MR3.csv");
	ofstream mutants_killed_MR4(path_out + "V11_killed_MR4.csv");
	ofstream mutants_killed_MR5(path_out + "V11_killed_MR5.csv");
	ofstream mutants_killed_MR6(path_out + "V11_killed_MR6.csv");
	ofstream mutants_killed_MR7(path_out + "V11_killed_MR7.csv");
	ofstream mutants_killed_MR8(path_out + "V11_killed_MR8.csv");

	string s = "";
	ofstream log(path_out + "V11_process_MRs_log_2025.txt");
	...
	// Transfer the matrix to the file V11_mutants_killed.csv
	...
	// Transfer the matrix_MRx to the file V11_mutants_killed_diff_outputs.csv
