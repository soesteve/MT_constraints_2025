    ...
    with open(path_to_mzn, 'r', encoding='utf-8') as f_source:
        ...
        for op in OPERATORS:
            for i, mut in enumerate(op.analyze(source)):
                ...
                with open(output_dir / mutant_filename, 'w', encoding='utf-8') as f_m:
...
if __name__ == "__main__":
  ...
  parser.add_argument("--original", type=Path, help="Path to the MiniZinc file to generate mutants for")
  parser.add_argument("--output-dir", type=Path,
                     default="Mutants", help="Directory to write mutants to")

  args = parser.parse_args()
  generate_mutants(args.original, args.output_dir)
